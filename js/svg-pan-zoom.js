...
, _createZoomIn: function(instance) {
    var zoomIn = document.getElementById('svg-pan-zoom-zoom-in');
...
, _createZoomReset: function(instance){
    // reset
    var resetPanZoomControl = document.getElementById('svg-pan-zoom-reset-pan-zoom');
...
, _createZoomOut: function(instance){
    // zoom out
    var zoomOut = document.getElementById('svg-pan-zoom-zoom-out');
...
, getOrCreateViewport: function(svg, selector) {
    ...
    if (!viewport) {
      var viewportId = 'viewport-map-transform';
